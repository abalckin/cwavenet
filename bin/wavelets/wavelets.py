...
if version_info >= (2,6,0):
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_wavelets', [dirname(__file__)])
        except ImportError:
            import _wavelets
            return _wavelets
        if fp is not None:
            try:
                _mod = imp.load_module('_wavelets', fp, pathname, description)
            finally:
                fp.close()
            return _mod
    _wavelets = swig_import_helper()
...
class Wavelet(_object):
    ...
    def h(self, *args):
        ...
        """
        return _wavelets.Wavelet_h(self, *args)
    ...
    def db(self, *args):
        ...
        """
        return _wavelets.Wavelet_db(self, *args)
    ...
    def dp(self, *args):
        ...
        """
        return _wavelets.Wavelet_dp(self, *args)
    ...
    def tau(*args):
        ...
        """
        return _wavelets.Wavelet_tau(*args)

    if _newclass:tau = staticmethod(tau)
    __swig_getmethods__["tau"] = lambda x: tau
    __swig_destroy__ = _wavelets.delete_Wavelet
    __del__ = lambda self : None;
Wavelet_swigregister = _wavelets.Wavelet_swigregister
...
class Morlet(Wavelet):
    ...
    def __init__(self): 
        ...
        this = _wavelets.new_Morlet()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _wavelets.delete_Morlet
    __del__ = lambda self : None;
Morlet_swigregister = _wavelets.Morlet_swigregister
